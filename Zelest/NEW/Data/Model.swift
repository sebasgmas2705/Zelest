...
struct HoroscopePreStatic: Identifiable, Codable {
...
var cellsData = [
    ...
    HoroscopePreStatic(id: UUID(), name: "Taurus", image: "taurus", dateRange: "April 20 - May 20"),
    HoroscopePreStatic(id: UUID(), name: "Virgo", image: "virgo", dateRange: "Aug 23 - Sep 22"),
    HoroscopePreStatic(id: UUID(), name: "Gemini", image: "gemini", dateRange: "May 21 - Jun 20"),
    HoroscopePreStatic(id: UUID(), name: "Cancer", image: "cancer", dateRange: "Jun 21 - Jul 22"),
    HoroscopePreStatic(id: UUID(), name: "Aries", image: "aries", dateRange: "Mar 21 - Apr 19"),
    HoroscopePreStatic(id: UUID(), name: "Leo", image: "leo", dateRange: "Jul 23 - Aug 22"),
    HoroscopePreStatic(id: UUID(), name: "Libra", image: "libra", dateRange: "Sep 23 - Oct 22"),
    HoroscopePreStatic(id: UUID(), name: "Scorpio", image: "scorpio", dateRange: "Oct 23 - Nov 21"),
    HoroscopePreStatic(id: UUID(), name: "Sagittarius", image: "sagittarius", dateRange: "Nov 22 - Dec 21"),
    HoroscopePreStatic(id: UUID(), name: "Capricorn", image: "capricorn", dateRange: "Dec 22 - Jan 19"),
    HoroscopePreStatic(id: UUID(), name: "Pisces", image: "pisces", dateRange: "Feb 19 - Mar 20"),
    HoroscopePreStatic(id: UUID(), name: "Aquarius", image: "aquarius", dateRange: "Jan 20 - Feb 18")
]
